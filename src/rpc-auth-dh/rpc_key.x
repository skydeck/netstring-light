 ...
 */
enum keystatus {
	KEY_SUCCESS = 0,	/* no problems */
	KEY_NOSECRET = 1,	/* no secret key stored */
	KEY_UNKNOWN = 2,	/* unknown netname */
	KEY_SYSTEMERR = 3 	/* system error (out of memory, encryption failure) */
};
 ...
 */
struct cryptkeyarg2 {
	netnamestr remotename => remotename2;
	netobj	remotekey;	/* Contains a length up to 1024 bytes */
	des_block deskey => deskey2;
};
